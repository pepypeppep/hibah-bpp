                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if ($hibah->status_pencairan == 1)
                                    <h6><span class="badge badge-warning">Verifikasi Berkas BPP</span></h6>
                                @elseif ($hibah->status_pencairan == 2)
                                    <h6><span class="badge badge-info">Pengajuan Keuangan UGM</span></h6>
                                @elseif ($hibah->status_pencairan == 3)
                                    <h6><span class="badge badge-success">Terbayar</span></h6>
