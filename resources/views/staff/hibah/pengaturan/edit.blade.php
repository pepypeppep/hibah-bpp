        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('s_hibah.pengaturan.update', $hibah->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-group">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="hibah_judul" class="form-control" placeholder="" value="{{ $hibah->hibah_judul }}" required>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <select name="hibah_kategori" class="form-control select2" style="width: 100%;" required>
                                            <option value="">-</option>
                                            <option value="7" {{ $hibah->hibah_kategori_id == 7 ? 'selected' : '' }}>Penelitian</option>
                                            <option value="8" {{ $hibah->hibah_kategori_id == 8 ? 'selected' : '' }}>Pengabdian</option>
                                            <option value="9" {{ $hibah->hibah_kategori_id == 9 ? 'selected' : '' }}>Publikasi</option>
                                            <option value="10" {{ $hibah->hibah_kategori_id == 10 ? 'selected' : '' }}>Pendidikan</option>
                                        </select>
                                        <span class="invalid-feedback">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="hibah_tgl_publish" class="form-control datetimepicker" placeholder="" value="{{ $hibah->hibah_tgl_publish }}" required>
                                        <span class="invalid-feedback">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="hibah_tgl_mulai" class="form-control datetimepicker" placeholder="" value="{{ $hibah->hibah_tgl_mulai }}" required>
                                        <span class="invalid-feedback">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="hibah_tgl_selesai" class="form-control datetimepicker" placeholder="" value="{{ $hibah->hibah_tgl_selesai }}" required>
                                        <span class="invalid-feedback">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="hibah_tgl_mulai_laporankemajuan" class="form-control datetimepicker" placeholder="" value="{{ $hibah->hibah_tgl_mulai_laporankemajuan }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-3 text-right">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="hibah_tgl_selesai_laporankemajuan" class="form-control datetimepicker" placeholder="" value="{{ $hibah->hibah_tgl_selesai_laporankemajuan }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-3 text-right">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="hibah_tgl_mulai_laporanfinal" class="form-control datetimepicker" placeholder="" value="{{ $hibah->hibah_tgl_mulai_laporanfinal }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-3 text-right">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="hibah_tgl_selesai_laporanfinal" class="form-control datetimepicker" placeholder="" value="{{ $hibah->hibah_tgl_selesai_laporanfinal }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-3 text-right">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="hibah_tgl_pengumuman" class="form-control datetimepicker" placeholder="" value="{{ $hibah->hibah_tgl_pengumuman }}" required>
                                        <span class="invalid-feedback">
