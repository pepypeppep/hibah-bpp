                                    ...
                                    <div class="col-md-9">
                                        <select name="hibah_kategori" class="form-control select2" style="width: 100%;"
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" {{ $hibah->hibah_kategori_id == $category->id ? 'selected' : '' }}>{{ $category->nama }}</option>
                                            @endforeach
                                        </select>
                                        <span class="invalid-feedback">
                                    ...
                                    <div class="col-md-9">
                                        <select name="hibah_unit_id" class="form-control select2" style="width: 100%;"
                                            ...
                                            @foreach ($units as $unit)
                                                <option value="{{ $unit->id }}" {{ $hibah->unit_id == $unit->id ? 'selected' : '' }}>{{ $unit->nama }}</option>
                                            @endforeach
                                        </select>
                                        <span class="invalid-feedback">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <label class="btn btn-outline-danger {{ $hibah->luaran == 0 ? 'active' : '' }}">
                                                <input type="radio" name="luaran" autocomplete="off" value="0" {{ $hibah->luaran == 0 ? 'checked' : '' }}> Tidak Wajib
                                            </label>
                                            <label class="btn btn-outline-info {{ $hibah->luaran == 1 ? 'active' : '' }}">
                                                <input type="radio" name="luaran" autocomplete="off" value="1" {{ $hibah->luaran == 1 ? 'checked' : '' }}> Wajib
                                            </label>
                                        </div>
                                        <span class="invalid-feedback">
