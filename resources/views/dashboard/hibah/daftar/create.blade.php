                        ...
                        <form method="POST" action="{{ route('hibah.daftar.pengajuan.store', $hibah->id) }}">
                            ...
                            <div class="form-group">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <span>[{{ $hibah->category->nama }}] {{ $hibah->hibah_judul }}</span>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-2 text-right">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input set_ketua" id="checkKetuaid" name="set_ketua[]" value="3" onclick="checkKetua()">
