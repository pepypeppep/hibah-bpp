                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="title" class="form-control" placeholder="Judul Hibah" value="JUDUL_HIBAH">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-2 text-right">
                                ...
                                <div class="col-md-10">
                                    <div class="mb-3">
                                        <textarea class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">ISIDATA</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10 text-right">
                                    ...
                                    <a href="{{ route('hibah.riwayat.upload') }}" type="submit" class="btn btn-success">Selanjutnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
